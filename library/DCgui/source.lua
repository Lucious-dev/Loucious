...
-- Helper function untuk buat UI element
...
function UILibrary:CreateWindow(title)
    ...
    local MainFrame = CreateElement("Frame", {
        Name = "MainFrame",
        Parent = ScreenGui,
        BackgroundColor3 = Color3.fromRGB(54, 57, 63), -- Discord dark
        BorderSizePixel = 0,
    ...
    local TitleLabel = CreateElement("TextLabel", {
        ...
        TextColor3 = Color3.fromRGB(114, 137, 218), -- Discord blurple
        TextSize = 26,
        TextXAlignment = Enum.TextXAlignment.Left
    })

    -- Кнопка «Закрыть и свернуть»
    ...
    -- Аватар и имя пользователя в левом нижнем углу.
